...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, JYEN,BSLS,     INS, HOME,PGUP,    NLCK,PSLS,PAST,PMNS,
    ...
    LCTL,LGUI,LALT,MHEN,          SPC,           HENK,KANA,RGUI,RGUI,FN0, FN0,     LEFT,DOWN,RGHT,         P0,  PDOT,PEQL
    ),
    UNIMAP(
